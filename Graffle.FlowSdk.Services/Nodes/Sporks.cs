    ...
    public static class Sporks
    {
        ...
        public static Spork GetSporkByName(string sporkName)
        {
            return sporkName switch
            {
                ...
                _ when sporkName == TestNetSporks.TestNet36.Name => new Spork(TestNetSporks.TestNet36.Name, TestNetSporks.TestNet36.NODE, TestNetSporks.TestNet36.ROOT_HEIGHT, TestNetSporks.TestNet.ROOT_HEIGHT - 1, true),
                ...
                _ when sporkName == MainNetSporks.MainNet18.Name => new Spork(MainNetSporks.MainNet18.Name, MainNetSporks.MainNet18.NODE, MainNetSporks.MainNet18.ROOT_HEIGHT, MainNetSporks.MainNet.ROOT_HEIGHT - 1),
        ...
        public static Spork GetDevSporkByHeight(ulong blockHeight)
        {
            return blockHeight switch
            {
                ...
                _ when blockHeight >= TestNetSporks.TestNet36.ROOT_HEIGHT && blockHeight < TestNetSporks.TestNet.ROOT_HEIGHT => new Spork(TestNetSporks.TestNet36.Name, TestNetSporks.TestNet36.NODE, TestNetSporks.TestNet36.ROOT_HEIGHT, TestNetSporks.TestNet.ROOT_HEIGHT - 1, true),
        ...
        public static Spork GetMainSporkByHeight(ulong blockHeight)
        {
            return blockHeight switch
            {
                ...
                _ when blockHeight >= MainNetSporks.MainNet18.ROOT_HEIGHT && blockHeight < MainNetSporks.MainNet.ROOT_HEIGHT => new Spork(MainNetSporks.MainNet18.Name, MainNetSporks.MainNet18.NODE, MainNetSporks.MainNet18.ROOT_HEIGHT, MainNetSporks.MainNet.ROOT_HEIGHT - 1),
