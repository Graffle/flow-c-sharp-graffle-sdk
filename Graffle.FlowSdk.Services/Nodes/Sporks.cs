    ...
    public static class Sporks
    {
        ...
        public static Spork GetSporkByName(string sporkName) =>
            sporkName switch
            {
                ...
                _ when sporkName == TestNetSporks.TestNet45.Name => new Spork(TestNetSporks.TestNet45.Name, TestNetSporks.TestNet45.NODE, TestNetSporks.TestNet45.ROOT_HEIGHT, TestNetSporks.TestNet.ROOT_HEIGHT - 1, true),
                ...
                _ when sporkName == MainNetSporks.MainNet22.Name => new Spork(MainNetSporks.MainNet22.Name, MainNetSporks.MainNet22.NODE, MainNetSporks.MainNet22.ROOT_HEIGHT, MainNetSporks.MainNet.ROOT_HEIGHT - 1),
        ...
        public static Spork GetDevSporkByHeight(ulong blockHeight) =>
             blockHeight switch
             {
                 ...
                 _ when blockHeight >= TestNetSporks.TestNet45.ROOT_HEIGHT && blockHeight < TestNetSporks.TestNet.ROOT_HEIGHT => new Spork(TestNetSporks.TestNet45.Name, TestNetSporks.TestNet45.NODE, TestNetSporks.TestNet45.ROOT_HEIGHT, TestNetSporks.TestNet.ROOT_HEIGHT - 1, true),
        ...
        public static Spork GetMainSporkByHeight(ulong blockHeight) =>
            blockHeight switch
            {
                ...
                _ when blockHeight >= MainNetSporks.MainNet22.ROOT_HEIGHT && blockHeight < MainNetSporks.MainNet.ROOT_HEIGHT => new Spork(MainNetSporks.MainNet22.Name, MainNetSporks.MainNet22.NODE, MainNetSporks.MainNet22.ROOT_HEIGHT, MainNetSporks.MainNet.ROOT_HEIGHT - 1),
