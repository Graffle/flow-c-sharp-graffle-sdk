    ...
    public static class Sporks
    {
        ...
        public static Spork GetSporkByName(string sporkName)
        {
            return sporkName switch
            {
                ...
                _ when sporkName == TestNetSporks.TestNet34.Name => new Spork(TestNetSporks.TestNet34.Name, TestNetSporks.TestNet34.NODE, TestNetSporks.TestNet34.ROOT_HEIGHT, TestNetSporks.TestNet.ROOT_HEIGHT - 1, true),
                ...
                _ when sporkName == MainNetSporks.MainNet16.Name => new Spork(MainNetSporks.MainNet16.Name, MainNetSporks.MainNet16.NODE, MainNetSporks.MainNet16.ROOT_HEIGHT, MainNetSporks.MainNet.ROOT_HEIGHT - 1),
        ...
        public static Spork GetDevSporkByHeight(ulong blockHeight)
        {
            return blockHeight switch
            {
                ...
                _ when blockHeight >= TestNetSporks.TestNet34.ROOT_HEIGHT && blockHeight < TestNetSporks.TestNet.ROOT_HEIGHT => new Spork(TestNetSporks.TestNet34.Name, TestNetSporks.TestNet34.NODE, TestNetSporks.TestNet34.ROOT_HEIGHT, TestNetSporks.TestNet.ROOT_HEIGHT - 1, true),
        ...
        public static Spork GetMainSporkByHeight(ulong blockHeight)
        {
            return blockHeight switch
            {
                ...
                _ when blockHeight >= MainNetSporks.MainNet16.ROOT_HEIGHT && blockHeight < MainNetSporks.MainNet.ROOT_HEIGHT => new Spork(MainNetSporks.MainNet16.Name, MainNetSporks.MainNet16.NODE, MainNetSporks.MainNet16.ROOT_HEIGHT, MainNetSporks.MainNet.ROOT_HEIGHT - 1),
