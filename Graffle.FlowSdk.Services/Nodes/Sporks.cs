    ...
    public static class Sporks
    {
        ...
        public static Spork GetSporkByName(string sporkName)
        {
            return sporkName switch
            {
                ...
                _ when sporkName == TestNetSporks.TestNet35.Name => new Spork(TestNetSporks.TestNet35.Name, TestNetSporks.TestNet35.NODE, TestNetSporks.TestNet35.ROOT_HEIGHT, TestNetSporks.TestNet.ROOT_HEIGHT - 1, true),
        ...
        public static Spork GetDevSporkByHeight(ulong blockHeight)
        {
            return blockHeight switch
            {
                ...
                _ when blockHeight >= TestNetSporks.TestNet35.ROOT_HEIGHT && blockHeight < TestNetSporks.TestNet.ROOT_HEIGHT => new Spork(TestNetSporks.TestNet35.Name, TestNetSporks.TestNet35.NODE, TestNetSporks.TestNet35.ROOT_HEIGHT, TestNetSporks.TestNet.ROOT_HEIGHT - 1, true),
