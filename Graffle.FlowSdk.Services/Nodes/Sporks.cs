    ...
    public static class Sporks
    {
        ...
        public static Spork GetSporkByName(string sporkName)
        {
            return sporkName switch
            {
                ...
                _ when sporkName == TestNetSporks.TestNet31.Name => new Spork(TestNetSporks.TestNet31.Name, TestNetSporks.TestNet31.NODE, TestNetSporks.TestNet31.ROOT_HEIGHT, TestNetSporks.TestNet.ROOT_HEIGHT - 1, true),
                ...
                _ when sporkName == MainNetSporks.MainNet14.Name => new Spork(MainNetSporks.MainNet14.Name, MainNetSporks.MainNet14.NODE, MainNetSporks.MainNet14.ROOT_HEIGHT, MainNetSporks.MainNet.ROOT_HEIGHT - 1),
        ...
        public static Spork GetDevSporkByHeight(ulong blockHeight)
        {
            return blockHeight switch
            {
                ...
                _ when blockHeight >= TestNetSporks.TestNet31.ROOT_HEIGHT && blockHeight < TestNetSporks.TestNet.ROOT_HEIGHT => new Spork(TestNetSporks.TestNet31.Name, TestNetSporks.TestNet31.NODE, TestNetSporks.TestNet31.ROOT_HEIGHT, TestNetSporks.TestNet.ROOT_HEIGHT - 1, true),
                _ when blockHeight >= TestNetSporks.TestNet20.ROOT_HEIGHT && blockHeight < TestNetSporks.TestNet31.ROOT_HEIGHT => new Spork(TestNetSporks.TestNet30.Name, TestNetSporks.TestNet30.NODE, TestNetSporks.TestNet30.ROOT_HEIGHT, TestNetSporks.TestNet31.ROOT_HEIGHT - 1, true),
        ...
        public static Spork GetMainSporkByHeight(ulong blockHeight)
        {
            return blockHeight switch
            {
                ...
                _ when blockHeight >= MainNetSporks.MainNet14.ROOT_HEIGHT && blockHeight < MainNetSporks.MainNet.ROOT_HEIGHT => new Spork(MainNetSporks.MainNet14.Name, MainNetSporks.MainNet14.NODE, MainNetSporks.MainNet14.ROOT_HEIGHT, MainNetSporks.MainNet.ROOT_HEIGHT - 1),
