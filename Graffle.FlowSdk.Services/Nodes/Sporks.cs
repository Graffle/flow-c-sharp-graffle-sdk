    ...
    public static class Sporks
    {
        ...
        public static Spork GetSporkByName(string sporkName) =>
            sporkName switch
            {
                ...
                _ when sporkName == TestNetSporks.TestNet39.Name => new Spork(TestNetSporks.TestNet39.Name, TestNetSporks.TestNet39.NODE, TestNetSporks.TestNet39.ROOT_HEIGHT, TestNetSporks.TestNet.ROOT_HEIGHT - 1, true),
        ...
        public static Spork GetDevSporkByHeight(ulong blockHeight) =>
             blockHeight switch
             {
                 ...
                 _ when blockHeight >= TestNetSporks.TestNet39.ROOT_HEIGHT && blockHeight < TestNetSporks.TestNet.ROOT_HEIGHT => new Spork(TestNetSporks.TestNet39.Name, TestNetSporks.TestNet39.NODE, TestNetSporks.TestNet39.ROOT_HEIGHT, TestNetSporks.TestNet.ROOT_HEIGHT - 1, true),
